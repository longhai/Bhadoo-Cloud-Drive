    ...
    <jsp:attribute name="body_area">
        ...
        <section class="dashboard-counts no-padding-bottom center">
            <div class="container-fluid">
                <div class="row bg-white has-shadow">
	                ...
	                <p style="font-size: 20px; color: #ed3424">Bạn cần phải đăng nhập</p>
        ...
        <ul class="breadcrumb">
            <div class="container-fluid">
                ...
                <li class="breadcrumb-item active">Tải lên mới</li>
            </div>
        </ul>
          <!-- Forms Section-->
          <section class="forms">
                      ...
                      <div class="col-lg-12">
                          <div class="card">
                              <div class="card-header d-flex align-items-center">
                                  <h3 class="h4">Nhập thông tin tệp</h3>
                              </div>
                              <div class="card-body">
                                  <form method="post" id="uploadform" action="${pageContext.request.contextPath}/api/drive/upload">
                                      <div class="form-group">
                                          <label class="form-control-label">URL</label>
                                          <input type="url" id="url" name="url" placeholder="Nhập URL tệp tại đây"
                                                 class="form-control">
                                      </div>
                                      <div class="form-group">
                                          <label class="form-control-label">Tên tệp</label>
                                          <input type="text" id="filename" name="filename"
                                                 placeholder="Nhập tên tệp tại đây"
                                                 class="form-control">
                                          <span class="help-block-none">Tên tệp là tùy chọn.</span>
                                      </div>
                                      <div class="form-group row">
                                          <div class="col-sm-12 offset-sm-5">
                                              <button type="submit" id="submit" class="btn btn-primary">Tải lên</button>
                                          </div>
                                      </div>
                                  </form>
                              </div>
